...
public actor AnalyticsLogDestination: LogDestination {
...
extension AnalyticsLogDestination {
    /// 사용자 속성 설정
    ...
    /// 화면 이름 설정
    public func setScreenName(_ screenName: String, screenClass: String? = nil) {
